    ...
    <section id="intro" class="intro" >
		...
		<div class="page-scroll">
			<a href="#wynm" class="btn btn-circle">
...
<!-- Three -->
			...
			<div class="col-xs-6 col-sm-3 col-md-3 ">
				...
				<br />
				<br />
				<button class ="btn btn-skin" value="VIEW MORE">VIEW MORE</button>
            </div>
			-->
        </div>		
		</div>
...
<div class="slider" align="center" >
   <div class="box col-md-3 col-lg-3">
	...
	<!-- /Section: graph compariosn section -->

	<!-- Section: REGULAR VS FRATCIONAL OWNERSHIP -->
