	<!-- Section: faq-html -->
    <section id="faq-html" class="home-section">
    ...
    <div class="row">
        <div class="col-lg-12">
									...
									<br />
									<li href="#l6" data-toggle="collapse" >What do I get when I invest in one of the projects?</li> 
									<div id="l6" class="collapse" ><br/>
									...
									<div align ="center">			
									<br />
									<!-- JAVA SCRIPT FOR SLIDDER -->
								    
									<span id="in"><!--OUTPUT OF JS--> <br /></span>
									<br />
									<input id ="slider1" type="range" min="100000" max="10000000" value="0" step="50000" onchange="inWords(this.value) "  style="width:20em"/>
									<br >
									<br >
									...
									<li href="#l7" data-toggle="collapse" >What is the 'Hold Period'?</li>
									<div id="l7" class="collapse" ><br/>
									...
									<br />
									<li href="#l8" data-toggle="collapse" >What is my security?</li>
									<div id="l8" class="collapse" ><br/>
									...
									<br />
									<li href="#l9" data-toggle="collapse" >Can I withdraw my investment before the end of 'Hold Period'?</li>
									<div id="l9" class="collapse" ><br/>
									...
									<br />
									<li href="#l10" data-toggle="collapse" >What is the process to sell my share before the end of 'Hold Period'?</li>
									<div id="l10" class="collapse" ><br/>
									...
									<br />
									<li href="#l11" data-toggle="collapse" >Are the investments risky? Is there any assured return?</li>
									<div id="l11" class="collapse" ><br/>
									...
									<br />
									<li href="#l12" data-toggle="collapse" >What if there is slow growth or depreciation of the purchased property at the end of hold period?</li>
									<div id="l12" class="collapse" ><br/>
									...
									<br />
									<li href="#l13" data-toggle="collapse" >What are the tax implications? Do I get tax benefits like I get on taking a home loan?</li>
									<div id="l13" class="collapse" ><br/>
